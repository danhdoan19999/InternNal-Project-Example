...
import static com.nals.rw360.errors.ErrorCodes.GROUP_TYPE_ID_NOT_NULL;
...
public class SubGroupUpdateReq {
    @NotBlank
    @Size(max = 55)
    @ErrorMappings({
    ...
    @NotNull
    @ErrorMapping(value = NotNull.class, code = GROUP_TYPE_ID_NOT_NULL)
