...
import com.nals.rw360.repository.timezone.DateTimeWrapper;
import com.nals.rw360.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(final String fieldName, final long id) {
        return format("SELECT %s FROM rw_date_time_wrapper where id=%d", fieldName, id);
    }
